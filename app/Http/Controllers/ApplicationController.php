...
{
    public static $pageTitle        ='Application';
    public static $modelName        ='App\Application';
    public static $folderPath       ='applications';
    public static $permissionName   ='application';
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = self::$modelName::with(['project'])->select(
    ...
    public function create()
    {
        ...
        $permissionName = self::$folderPath;
        return view(self::$folderPath . '.create', compact('pageTitle', 'pageDescription', 'page_breadcrumbs', 'permissionName', 'project'));
    ...
    {
        $data = self::$modelName::with(['project'])->findOrFail($id);
        $pageTitle = self::$pageTitle;
    ...
    public function edit($id)
    {
        ...
        $permissionName = self::$folderPath;
        return view(self::$folderPath . '.edit', compact('pageTitle', 'pageDescription', 'page_breadcrumbs', 'permissionName','data','project'));
    }
