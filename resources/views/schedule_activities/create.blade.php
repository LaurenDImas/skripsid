    ...
    <div class="card card-custom">
        ...
        {!! Form::open(array('route' => ''.$permissionName.'.store','method'=>'POST', 'files' => true)) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="input-group date">
                                        <input type="text" class="form-control" name="date" value="{{ old('date') }}" readonly="readonly" id="kt_datepicker_3" />
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="constraint" placeholder="Ada/Tidak" class="form-control" value="{{ old('kendala') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <textarea name="activity" id="editor"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-primary mr-2" id="kt_login_signin_submit">Submit</button>
...
<script>
    ...
    $('#project_id').prepend('<option selected=""></option>').select2({placeholder: "Choose an project"});
    ...
    //     $.ajax({
    //         url:'{{ route("new_assignments-email") }}',
    //         method:'post',
    //         data: {
    //             "user_id": user_id
    //         },           
