                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="input-group date">
                                        <input type="text" class="form-control" name="date" value="{{ date("d/m/Y", strtotime($data->date)) }}" readonly="readonly" id="kt_datepicker_3" />
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <textarea name="activity" id="editor">{{ $data->activity }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10"> 
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="input-group date">
                                                <input type="time" name="hour_start" class="form-control" value="{{$data->hour_start}}" />
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                        <i class="la la-calendar"></i>
                                                    </span>
                                        ...
                                        <div class="col-6">
                                            <div class="input-group date">
                                                <input type="time" name="hour_end" class="form-control" value="{{$data->hour_end}}" />
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                        <i class="la la-calendar"></i>
                                                    </span>
