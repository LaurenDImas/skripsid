...
<div class="card card-custom gutter-b example example-compact">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            ...
            <a href="{{url($permissionName.'/'. Crypt::encrypt($data->id).'/edit')}}" class="btn btn-success font-weight-bolder">
            ...
            @endif
            <a href="{{url($permissionName1)}}" class="btn btn-primary font-weight-bolder ml-2">
                <span class="svg-icon svg-icon-md">
    ...
    <div class="card-body"> 
        <table class="table  table-hover">
            ...
            <tr>
                ...
                <th width="1%" class="text-center">:</th>
                <th width="18%" >{!! $data->activity !!}</th>
                <th width="7%">Note</th>
                <th width="1%" class="text-center">:</th>
                <th width="18%" >{!! $data->note !!}</th>
            </tr>
            
            <tr>
                <th width="7%">Jam Mulai</th>
                <th width="1%" class="text-center">:</th>
                <th width="18%" >{!! $data->hour_start !!}</th>
                <th width="7%">Jam Selesai</th>
                <th width="1%" class="text-center">:</th>
                <th width="18%" >{!! $data->hour_end !!}</th>
            </tr>
             <tr>
                <th width="7%">File</th>
                <th width="1%" class="text-center">:</th>
